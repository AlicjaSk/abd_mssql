...
public class ClosingComment {
    ...
    public boolean equals(Object o) {
        ...
        ClosingComment that = (ClosingComment) o;

        if (commentId != that.commentId) return false;
        if (taskFk != null ? !taskFk.equals(that.taskFk) : that.taskFk != null) return false;
        if (issueFk != null ? !issueFk.equals(that.issueFk) : that.issueFk != null) return false;
